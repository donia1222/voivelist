export const translations = {
  en: {
    ...
    saved: "My Lists",
    calendar: "Calendar",
    shoppingCalendar: "Shopping Calendar",
    priceCalculator: "Prices",
    priceCalculatorTitle: "Calculate Prices",
    manualList: "Manual",
  ...
  es: {
    ...
    createTab: "Crear",
    attachTab: "Adjuntar",
    myListsTab: "Mis listas",
    calculatorTab: "Calculador",
    imageList: "Imagen",
    analyzeList: "Analizar lista",
    saved: "Mis listas",
    calendar: "Calendario",
    shoppingCalendar: "Calendario de compras",
    priceCalculator: "Precios",
    priceCalculatorTitle: "Calcular Precios",
  ...
  de: {
    ...
    createTab: "Erstellen",
    attachTab: "Anhängen",
    myListsTab: "Meine Listen",
    calculatorTab: "Rechner",
    imageList: "Bild",
    analyzeList: "Liste analysieren",
    saved: "Meine Listen",
    calendar: "Kalender",
    shoppingCalendar: "Einkaufskalender",
    priceCalculator: "Preise",
    priceCalculatorTitle: "Preise berechnen",
    manualList: "Manuell",
  ...
  fr: {
    ...
    createTab: "Créer",
    attachTab: "Joindre",
    myListsTab: "Mes listes",
    calculatorTab: "Calculateur",
    imageList: "Image",
    analyzeList: "Analyser la liste",
    saved: "Mes listes",
    calendar: "Calendrier",
    shoppingCalendar: "Calendrier des achats",
    priceCalculator: "Prix",
    priceCalculatorTitle: "Calculer les prix",
    manualList: "Manuel",
  ...
  it: {
    ...
    createTab: "Crea",
    attachTab: "Allega",
    myListsTab: "Le mie liste",
    calculatorTab: "Calcolatore",
    imageList: "Immagine",
    analyzeList: "Analizza lista",
    saved: "Le mie liste",
    calendar: "Calendario",
    shoppingCalendar: "Calendario della spesa",
    priceCalculator: "Prezzi",
    priceCalculatorTitle: "Calcola prezzi",
    manualList: "Manuale",
  ...
  tr: {
    ...
    createTab: "Oluştur",
    attachTab: "Ekle",
    myListsTab: "Listelerim",
    calculatorTab: "Hesaplayıcı",
    imageList: "Görüntü",
    analyzeList: "Listeyi analiz et",
    saved: "Listelerim",
    calendar: "Takvim",
    shoppingCalendar: "Alışveriş takvimi",
    priceCalculator: "Fiyatlar",
    priceCalculatorTitle: "Fiyatları hesapla",
    manualList: "Manuel",
  ...
  pt: {
    ...
    createTab: "Criar",
    attachTab: "Anexar",
    myListsTab: "Minhas listas",
    calculatorTab: "Calculadora",
    imageList: "Imagem",
    analyzeList: "Analisar lista",
    saved: "Minhas listas",
    calendar: "Calendário",
    shoppingCalendar: "Calendário de compras",
    priceCalculator: "Preços",
    priceCalculatorTitle: "Calcular preços",
    manualList: "Manual",
  ...
  ru: {
    ...
    createList: "Голос",
    createTab: "Создать",
    attachTab: "Прикрепить",
    myListsTab: "Мои списки",
    calculatorTab: "Калькулятор",
    imageList: "Изображение",
    analyzeList: "Анализировать список",
    saved: "Мои списки",
    calendar: "Календарь",
    shoppingCalendar: "Календарь покупок",
    priceCalculator: "Цены",
    priceCalculatorTitle: "Рассчитать цены",
    manualList: "Вручную",
  ...
  ar: {
    ...
    saved: "قوائمي",
    calendar: "التقويم",
    shoppingCalendar: "تقويم التسوق",
    priceCalculator: "الأسعار",
    priceCalculatorTitle: "حساب الأسعار",
    manualList: "يدوي",
  ...
  hu: {
    ...
    createList: "Hang",
    createTab: "Létrehozás",
    attachTab: "Csatolás",
    myListsTab: "Listáim",
    calculatorTab: "Számológép",
    imageList: "Kép",
    analyzeList: "Lista elemzése",
    saved: "Listáim",
    calendar: "Naptár",
    shoppingCalendar: "Vásárlási naptár",
    priceCalculator: "Árak",
    priceCalculatorTitle: "Árak kiszámítása",
    manualList: "Kézi",
  ...
  ja: {
    ...
    saved: "マイリスト",
    calendar: "カレンダー",
    shoppingCalendar: "買い物カレンダー",
    priceCalculator: "価格",
    priceCalculatorTitle: "価格を計算",
    manualList: "手動",
  ...
  hi: {
    ...
    createList: "आवाज़",
    createTab: "बनाएं",
    attachTab: "संलग्न करें",
    myListsTab: "मेरी सूचियाँ",
    calculatorTab: "कैलकुलेटर",
    imageList: "छवि",
    analyzeList: "सूची का विश्लेषण करें",
    saved: "मेरी सूचियाँ",
    calendar: "कैलेंडर",
    shoppingCalendar: "खरीदारी कैलेंडर",
    priceCalculator: "कीमतें",
    priceCalculatorTitle: "कीमतों की गणना करें",
    manualList: "मैनुअल",
  ...
  nl: {
    ...
    createTab: "Maken",
    attachTab: "Bijvoegen",
    myListsTab: "Mijn lijsten",
    calculatorTab: "Rekenmachine",
    imageList: "Afbeelding",
    analyzeList: "Lijst analyseren",
    saved: "Mijn lijsten",
    calendar: "Kalender",
    shoppingCalendar: "Boodschappenkalender",
    priceCalculator: "Prijzen",
    priceCalculatorTitle: "Prijzen berekenen",
