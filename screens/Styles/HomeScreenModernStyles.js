...
export const getModernStyles = () => {
  return StyleSheet.create({
    ...
    welcomeIconContainer: {
      width: 72,
      height: 72,
      backgroundColor: "rgba(0, 255, 119, 0.1)",
      borderRadius: 36,
      alignItems: "center",
      justifyContent: "center",
      marginBottom: 16,
    ...
    chipInfoBenefitsTitle: {
      fontSize: 16,
      fontWeight: "600",
      color: "#1f2937",
      marginBottom: 12,
    },
    chipInfoBenefitsList: {
      gap: 8,
    },
    chipInfoBenefitItem: {
      flexDirection: "row",
