...
const labels = {
  en: {
    ...
    slide4Title: "Without barriers, with advertising",
    slide4Subtitle: "Use all features without barriers.",
    slide4Description: "Our app is completely free thanks to ads. You can subscribe to remove ads and support the maintenance and updates of the app. Your support is invaluable!",
  ...
  es: {
    ...
    slide4Title: "Sin barreras, con publicidad",
    slide4Subtitle: "Usa todas las funciones sin barreras.",
    slide4Description: "Nuestra app es completamente gratuita gracias a la publicidad. Puedes suscribirte para eliminar los anuncios y apoyar el mantenimiento y las actualizaciones de la app. ¡Tu apoyo es invaluable!",
  ...
  de: {
    ...
    slide4Title: "Ohne Barrieren, mit Werbung",
    slide4Subtitle: "Nutzen Sie alle Funktionen ohne Barrieren.",
    slide4Description: "Unsere App ist dank Werbung völlig kostenlos. Sie können sich anmelden, um Werbung zu entfernen und die Wartung und Aktualisierungen der App zu unterstützen. Ihre Unterstützung ist von unschätzbarem Wert!",
  ...
  it: {
    ...
    slide4Title: "Senza barriere, con pubblicità",
    slide4Subtitle: "Usa tutte le funzionalità senza barriere.",
    slide4Description: "La nostra app è completamente gratuita grazie alla pubblicità. Puoi iscriverti per rimuovere gli annunci e supportare la manutenzione e gli aggiornamenti dell'app. Il tuo supporto è inestimabile!",
  ...
  fr: {
    ...
    slide4Title: "Sans barrières, avec publicité",
    slide4Subtitle: "Utilisez toutes les fonctionnalités sans barrières.",
    slide4Description: "Notre application est totalement gratuite grâce à la publicité. Vous pouvez vous abonner pour supprimer les annonces et soutenir la maintenance et les mises à jour de l'application. Votre soutien est inestimable!",
  ...
  tr: {
    ...
    slide4Title: "Engelsiz, reklamlı",
    slide4Subtitle: "Tüm özellikleri engelsiz kullanın.",
    slide4Description: "Uygulamamız reklamlar sayesinde tamamen ücretsizdir. Reklamları kaldırmak ve uygulamanın bakımını ve güncellemelerini desteklemek için abone olabilirsiniz. Desteğiniz paha biçilemez!",
  ...
  pt: {
    ...
    slide4Title: "Sem barreiras, com publicidade",
    slide4Subtitle: "Use todos os recursos sem barreiras.",
    slide4Description: "Nosso aplicativo é totalmente gratuito graças aos anúncios. Você pode se inscrever para remover os anúncios e apoiar a manutenção e as atualizações do aplicativo. Seu apoio é inestimável!",
  ...
  ru: {
    ...
    slide4Title: "Без барьеров, с рекламой",
    slide4Subtitle: "Используйте все функции без барьеров.",
    slide4Description: "Наше приложение полностью бесплатно благодаря рекламе. Вы можете подписаться, чтобы убрать рекламу и поддержать обслуживание и обновления приложения. Ваша поддержка бесценна!",
  ...
  ar: {
    ...
    slide4Title: "بدون حواجز، مع إعلانات",
    slide4Subtitle: "استخدم جميع الميزات بدون حواجز.",
    slide4Description: "تطبيقنا مجاني تماماً بفضل الإعلانات. يمكنك الاشتراك لإزالة الإعلانات ودعم صيانة وتحديثات التطبيق. دعمك لا يقدر بثمن!",
  ...
  hu: {
    ...
    slide4Title: "Nincs akadály, reklámokkal",
    slide4Subtitle: "Használja az összes funkciót akadályok nélkül.",
    slide4Description: "Az alkalmazásunk teljesen ingyenes a reklámoknak köszönhetően. Feliratkozhat a reklámok eltávolítására és az alkalmazás karbantartásának és frissítéseinek támogatására. Támogatása felbecsülhetetlen értékű!",
  ...
  ja: {
    ...
    slide4Title: "障害なし、広告付き",
    slide4Subtitle: "障害なくすべての機能を利用する。",
    slide4Description: "アプリは広告のおかげで完全に無料です。広告を削除し、アプリのメンテナンスと更新をサポートするためにサブスクライブできます。あなたのサポートは非常に価値があります！",
  ...
  he: {
    ...
    slide4Title: "ללא מחסומים, עם פרסומות",
    slide4Subtitle: "השתמש בכל התכונות ללא מחסומים.",
    slide4Description: "האפליקציה שלנו היא חינמית לחלוטין בזכות פרסומות. אתה יכול להירשם כדי להסיר פרסומות ולתמוך בתחזוקה ועדכונים של האפליקציה. התמיכה שלך היא לא יסולא בפז!",
...
const slides = [
  ...
  },
  {
    ...
    image: require('../assets/images/gratis-2.png'), // Reemplaza con la ruta correcta
  },
  {
    id: '5',
